...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'generator_song', ['slug'])

        # Adding field 'Songbook.slug'
        db.add_column(u'generator_songbook', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='first-slug', max_length=100),
                      keep_default=False)

        # Adding field 'Songbook.is_public'
        db.add_column(u'generator_songbook', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Songbook.slug'
        db.delete_column(u'generator_songbook', 'slug')

        # Deleting field 'Songbook.is_public'
        db.delete_column(u'generator_songbook', 'is_public')

        # Adding unique constraint on 'Song', fields ['slug']
        db.create_unique(u'generator_song', ['slug'])
