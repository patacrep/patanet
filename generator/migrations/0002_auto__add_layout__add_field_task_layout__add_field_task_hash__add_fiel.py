...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Task', fields ['songbook']
        db.delete_unique(u'generator_task', ['songbook_id'])
        ...
        # Adding field 'Task.layout'
        db.add_column(u'generator_task', 'layout',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['generator.Layout']),
                      keep_default=False)

        # Adding field 'Task.hash'
        db.add_column(u'generator_task', 'hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Adding field 'Task.last_updated'
        db.add_column(u'generator_task', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 5, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Task.songbook'
        db.alter_column(u'generator_task', 'songbook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generator.Songbook']))

    def backwards(self, orm):
        # Deleting model 'Layout'
        db.delete_table(u'generator_layout')

        # Deleting field 'Task.layout'
        db.delete_column(u'generator_task', 'layout_id')

        # Deleting field 'Task.hash'
        db.delete_column(u'generator_task', 'hash')

        # Deleting field 'Task.last_updated'
        db.delete_column(u'generator_task', 'last_updated')


        # Changing field 'Task.songbook'
        db.alter_column(u'generator_task', 'songbook_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['generator.Songbook'], unique=True))
        # Adding unique constraint on 'Task', fields ['songbook']
        db.create_unique(u'generator_task', ['songbook_id'])
