...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'generator.songsinsongbooks': {
            'Meta': {'unique_together': "(('section', 'rank_in_section'),)", 'object_name': 'SongsInSongbooks'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rank_in_section': ('django.db.models.fields.IntegerField', [], {}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'section'", 'to': u"orm['generator.SectionInSongbooks']"}),
