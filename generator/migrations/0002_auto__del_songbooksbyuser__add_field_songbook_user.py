...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Songbook.user'
        db.add_column(u'generator_songbook', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='songbooks', to=orm['generator.Profile']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Songbook.user'
        db.delete_column(u'generator_songbook', 'user_id')
