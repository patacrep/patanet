...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Layout.lang'
        db.delete_column(u'generator_layout', 'lang')

        # Deleting field 'Layout.papersize'
        db.delete_column(u'generator_layout', 'papersize')

        # Deleting field 'Layout.other_options'
        db.delete_column(u'generator_layout', 'other_options')

        # Deleting field 'Layout.orientation'
        db.delete_column(u'generator_layout', 'orientation')


    def backwards(self, orm):
        # Adding field 'Layout.lang'
        db.add_column(u'generator_layout', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='french', max_length=10),
                      keep_default=False)

        # Adding field 'Layout.papersize'
        db.add_column(u'generator_layout', 'papersize',
                      self.gf('django.db.models.fields.CharField')(default='a4', max_length=16),
                      keep_default=False)

        # Adding field 'Layout.other_options'
        db.add_column(u'generator_layout', 'other_options',
                      self.gf('jsonfield.fields.JSONField')(default=[]),
                      keep_default=False)

        # Adding field 'Layout.orientation'
        db.add_column(u'generator_layout', 'orientation',
                      self.gf('django.db.models.fields.CharField')(default='portrait', max_length=16),
                      keep_default=False)
    ...
    models = {
        ...
        u'generator.layout': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'template': ('django.db.models.fields.CharField', [], {'default': "'data.tex'", 'max_length': '100'})
        },
        u'generator.profile': {
