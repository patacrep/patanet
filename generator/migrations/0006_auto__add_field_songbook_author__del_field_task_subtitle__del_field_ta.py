...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Songbook.author'
        db.add_column(u'generator_songbook', 'author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'Task.subtitle'
        db.delete_column(u'generator_task', 'subtitle')

        # Deleting field 'Task.author'
        db.delete_column(u'generator_task', 'author')

        # Deleting field 'Task.title'
        db.delete_column(u'generator_task', 'title')


    def backwards(self, orm):
        # Deleting field 'Songbook.author'
        db.delete_column(u'generator_songbook', 'author')

        # Adding field 'Task.subtitle'
        db.add_column(u'generator_task', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Task.author'
        db.add_column(u'generator_task', 'author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Task.title'
        db.add_column(u'generator_task', 'title',
    ...
    models = {
        ...
        u'generator.layout': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'orientation': ('django.db.models.fields.CharField', [], {'default': "'portrait'", 'max_length': '16'}),
            'other_options': ('jsonfield.fields.JSONField', [], {'default': '[]'}),
            'papersize': ('django.db.models.fields.CharField', [], {'default': "'a4'", 'max_length': '16'}),
