...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Song.language'
        db.delete_column(u'generator_song', 'language_id')

        # Adding field 'Song.language'
        db.add_column(u'generator_song', 'language',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'generator_language', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=6, unique=True)),
        ...
        # Deleting field 'Song.language'
        db.delete_column(u'generator_song', 'language')

        # Adding field 'Song.language'
        db.add_column(u'generator_song', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generator.Language'], null=True),
                      keep_default=False)
