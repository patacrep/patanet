...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Songbook.user'
        db.alter_column(u'generator_songbook', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Songbook.user'
        db.alter_column(u'generator_songbook', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generator.Profile']))
    ...
    models = {
        ...
        u'generator.songbook': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'songbooks'", 'to': u"orm['auth.User']"})
        },
        u'generator.task': {
