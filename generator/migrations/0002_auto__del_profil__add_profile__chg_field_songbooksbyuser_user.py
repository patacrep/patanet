...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SongbooksByUser.user'
        db.alter_column(u'generator_songbooksbyuser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generator.Profile']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SongbooksByUser.user'
        db.alter_column(u'generator_songbooksbyuser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generator.Profil']))
