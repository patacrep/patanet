...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.language'
        db.alter_column(u'generator_song', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['generator.Language'], null=True))

    def backwards(self, orm):

        # Changing field 'Song.language'
        db.alter_column(u'generator_song', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(default='unknown', to=orm['generator.Language']))
